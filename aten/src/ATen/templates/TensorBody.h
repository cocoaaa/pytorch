...
class CAFFE2_API Tensor {
 ...
 public:
  ...
  /// any dual at the selected level.
  /// This relies on view not calling back into this function! There is an
  /// explicit test for this in the autograd codegen.
  Tensor fw_primal(uint64_t level) const {
    if (!this->defined()) {
      return Tensor();
    } else {
      auto result = this->view(this->sizes());
